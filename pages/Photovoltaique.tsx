...
export const Photovoltaique: React.FC = () => {
  return (
    <div className="pt-20 bg-white dark:bg-neutral-950 transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative h-[65vh] flex items-center bg-primary overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl animate-float" style={{ animationDuration: '10s' }}>
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Devenez indépendant face à la hausse des prix de l'énergie. Installation clé en main, dimensionnée pour votre consommation réelle.
            </p>
