    ...
    <div className="bg-white dark:bg-neutral-950 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             <div className="relative group">
                ...
                <div className="absolute -top-6 -left-6 bg-accent text-primary p-6 rounded-xl shadow-lg hidden md:block">
                  ...
                  <p className="text-xs font-bold uppercase tracking-wider">Ans d'expérience</p>
                </div>
             </div>
             ...
             <div>
                ...
                <div className="grid grid-cols-2 gap-6 mt-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-primary dark:text-white">Décennale</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-primary dark:text-white">Maîtrise</h4>
                      <p className="text-sm text-gray-500">Un seul expert.</p>
                    </div>
                  </div>
                </div>
             </div>
      ...
      <section className="py-24 bg-neutral-50 dark:bg-neutral-950 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h3 className="font-display font-bold text-3xl md:text-4xl text-primary dark:text-white mb-12">
      ...
      {/* Quote Section */}
      <section className="py-24 bg-white dark:bg-neutral-900 transition-colors duration-300" id="devis">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="font-display font-bold text-3xl md:text-4xl text-primary dark:text-white mb-6">
              ...
              <div className="space-y-6 bg-neutral-50 dark:bg-neutral-800 p-8 rounded-2xl border dark:border-neutral-700">
                <a href={`tel:${COMPANY_INFO.phoneClean}`} className="flex items-center text-primary dark:text-white hover:text-accent transition-colors">
                    <Icons.Phone className="w-5 h-5 mr-4 text-accent" />
                    <span className="font-bold text-xl">{COMPANY_INFO.phone}</span>
                </a>
                <a href={`mailto:${COMPANY_INFO.email}`} className="flex items-center text-primary dark:text-white hover:text-accent transition-colors">
                    <Icons.Mail className="w-5 h-5 mr-4 text-accent" />
      ...
      <section className="py-20 bg-neutral-900 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 text-center text-white">
          <h2 className="font-display font-bold text-3xl mb-12">Zone d'Intervention</h2>
